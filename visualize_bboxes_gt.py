...
if __name__ == "__main__":
	resultsFile = "./datasets/BOP_DATASETS/doorlatch/train_pbr/000002/"
	resultsFile += "scene_gt_info.json"

	# imagePath = "./datasets/BOP_DATASETS/doorlatch/train_pbr/000002/rgb/"
	...
	for imgid in range(776, 777):
		img = cv2.imread(f"{imagePath}{imgid:06d}.tif")
